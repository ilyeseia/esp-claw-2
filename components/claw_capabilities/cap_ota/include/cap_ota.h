 ...
 *   - ota_update : download a firmware image from a URL into the inactive OTA
 *                  slot, set it as the boot partition and reboot. Restricted,
 *                  root-agent only — it replaces the running firmware.
 *
