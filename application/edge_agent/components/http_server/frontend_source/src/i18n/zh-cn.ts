...
export const zhCn: Dict = {
  ...
  sectionMqttOptions: 'MQTT 选项',
  mqttEnabled: '启用 MQTT',
  mqttEnabledHint: 'Wi-Fi 连接后在启动时连接到服务器。',
  mqttBroker: '服务器地址或 IP',
  mqttBrokerPlaceholder: 'broker.example.com',
  mqttPort: '端口',
  mqttTls: '使用 TLS',
  mqttTlsHint: '使用内置证书包校验服务器（端口通常为 8883）。',
  mqttUsername: '用户名',
  mqttPassword: '密码',
  mqttClientId: '客户端 ID',
  mqttClientIdHint: '留空则根据设备 MAC 生成稳定 ID。',
  mqttKeepalive: '心跳间隔（秒）',
  mqttQos: '默认 QoS',
  mqttBaseTopic: '基础主题',
  ...
  sectionVpnMode: 'VPN 模式',
  vpnMode: '模式',
  vpnModeHint: '关闭、Tailscale 网关（局域网子网路由器），或设备端 WireGuard 隧道。',
  vpnModeOff: '关闭',
  vpnModeGateway: 'Tailscale 网关',
  vpnModeWireguard: 'WireGuard（设备端隧道）',
  sectionVpnWireguard: 'WireGuard 隧道',
  wgEnabledHint: '在 Wi-Fi 与系统时间就绪后于启动时建立隧道。',
  wgPrivateKey: '私钥',
  wgAddress: '设备隧道地址',
  wgAddressHint: '本设备在隧道中的 IP，例如 10.2.0.2/32。',
  wgPeerPublicKey: '对端公钥',
  wgEndpoint: '对端端点（主机/IP）',
  wgEndpointPort: '对端端口',
  wgKeepalive: '持久保活（秒）',
  wgAllowedIps: '允许的 IP',
  wgAllowedIpsHint: '隧道承载的路由，例如 0.0.0.0/0 表示全量隧道。',
  wgPresharedKey: '预共享密钥（可选）',
  wgPresharedKeyHint: '与对端共享的可选对称密钥。',
  wgMakeDefault: '全量隧道（默认路由）',
