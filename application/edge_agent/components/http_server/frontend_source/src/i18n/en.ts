export const en = {
  ...
  sectionVpnMode: 'VPN Mode',
  vpnMode: 'Mode',
  vpnModeHint: 'Off, Tailscale gateway (LAN subnet-router), or an on-device WireGuard tunnel.',
  vpnModeOff: 'Off',
  vpnModeGateway: 'Tailscale gateway',
  vpnModeWireguard: 'WireGuard (on-device tunnel)',
  sectionVpnWireguard: 'WireGuard Tunnel',
  wgEnabledHint: 'Bring the tunnel up at boot once Wi-Fi and system time are ready.',
  wgPrivateKey: 'Private key',
  wgAddress: 'Device tunnel address',
  wgAddressHint: 'This device’s IP on the tunnel, e.g. 10.2.0.2/32.',
  wgPeerPublicKey: 'Peer public key',
  wgEndpoint: 'Peer endpoint (host/IP)',
  wgEndpointPort: 'Peer port',
  wgKeepalive: 'Persistent keepalive (s)',
  wgAllowedIps: 'Allowed IPs',
  wgAllowedIpsHint: 'Routes carried by the tunnel, e.g. 0.0.0.0/0 for full tunnel.',
  wgPresharedKey: 'Preshared key (optional)',
  wgPresharedKeyHint: 'Optional extra symmetric key shared with the peer.',
  wgMakeDefault: 'Full tunnel (default route)',
