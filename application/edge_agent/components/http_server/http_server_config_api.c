...
static const config_field_def_t CONFIG_FIELDS[] = {
    ...
    CONFIG_FIELD("vpn",          vpn_mode),
    CONFIG_FIELD("vpn",          wg_private_key),
    CONFIG_FIELD("vpn",          wg_address),
    CONFIG_FIELD("vpn",          wg_peer_public_key),
    CONFIG_FIELD("vpn",          wg_endpoint),
    CONFIG_FIELD("vpn",          wg_endpoint_port),
    CONFIG_FIELD("vpn",          wg_allowed_ips),
    CONFIG_FIELD("vpn",          wg_keepalive),
    CONFIG_FIELD("vpn",          wg_preshared_key),
    CONFIG_FIELD("vpn",          wg_make_default),
